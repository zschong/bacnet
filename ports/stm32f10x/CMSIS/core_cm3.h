 ...
 * Return the content of the base priority register
 */
static __INLINE uint32_t __get_BASEPRI(
    void
)
{
    register uint32_t __regBasePri __ASM(
        "basepri"
    );
    return (
               __regBasePri
 ...
 *
 * Set the base priority register
 */ static __INLINE void __set_BASEPRI(
    uint32_t basePri
)
{
    register uint32_t __regBasePri __ASM(
 ...
 * Return state of the priority mask bit from the priority mask register
 */
static __INLINE uint32_t __get_PRIMASK(
    void
)
{
    register uint32_t __regPriMask __ASM(
        "primask"
    );
    return (__regPriMask);
}
 ...
 * Set the priority mask bit in the priority mask register
 */
static __INLINE void __set_PRIMASK(
    uint32_t priMask
)
{
    register uint32_t __regPriMask __ASM(
 ...
 * Return the content of the fault mask register
 */
static __INLINE uint32_t __get_FAULTMASK(
    void
)
{
    register uint32_t __regFaultMask __ASM(
        "faultmask"
    );
 ...
 * Set the fault mask register
 */
static __INLINE void __set_FAULTMASK(
    uint32_t faultMask
)
{
    register uint32_t __regFaultMask __ASM(
 ...
 * Return the content of the control register
 */
static __INLINE uint32_t __get_CONTROL(
    void
)
{
    register uint32_t __regControl __ASM(
        "control"
    );
    return (__regControl);
}
 ...
 * Set the control register
 */
static __INLINE void __set_CONTROL(
    uint32_t control
)
{
    register uint32_t __regControl __ASM(
...
#else
__ATTRIBUTES unsigned long __get_MSP(
    void
);
__ATTRIBUTES void __set_MSP(
    unsigned long
);
__ATTRIBUTES unsigned long __get_PSP(
    void
);
__ATTRIBUTES void __set_PSP(
    unsigned long
);

__ATTRIBUTES unsigned long __REV16(
    unsigned long
);
__ATTRIBUTES unsigned long __RBIT(
    unsigned long
);
#endif
 ...
 */
static __INLINE void NVIC_SetPriorityGrouping(
 ...
 */ static __INLINE uint32_t NVIC_GetPriorityGrouping(
    void
)
{
 ...
 */
static __INLINE void NVIC_EnableIRQ(
    IRQn_Type IRQn
)
{
 ...
 * The interrupt number cannot be a negative value.
 */
static __INLINE void NVIC_DisableIRQ(
    IRQn_Type IRQn
)
{
 ...
 * The interrupt number cannot be a negative value.
 */
static __INLINE void NVIC_SetPendingIRQ(
    IRQn_Type IRQn
)
{
 ...
 */
static __INLINE void NVIC_SetPriority(
    IRQn_Type IRQn,
    uint32_t priority
)
{
 ...
 */
#ifndef __CSTAT__
static __INLINE uint32_t NVIC_GetPriority(
    IRQn_Type IRQn
)
{
...
)
{
    ...
    return (((PreemptPriority & ((1 << (PreemptPriorityBits)) -
                                 1)) << SubPriorityBits) | ((SubPriority & ((1 <<
                                         (SubPriorityBits)) - 1)))
           );
}
 ...
 */
static __INLINE uint32_t SysTick_Config(
    uint32_t ticks
)
{
 ...
 */
static __INLINE void NVIC_SystemReset(
    void
)
{
 ...
 */
static __INLINE uint32_t ITM_SendChar(
    uint32_t ch
)
{
 ...
 * It is blocking when a debugger is connected, but the previous character send is not transmitted.
 */
static __INLINE int ITM_ReceiveChar(
    void
)
{
 ...
 */
static __INLINE int ITM_CheckChar(
    void
)
{
