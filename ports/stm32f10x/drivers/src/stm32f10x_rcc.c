...
/**
  ...
  * @retval None
  */
void RCC_PREDIV2Config(
    uint32_t RCC_PREDIV2_Div
)
{
    uint32_t tmpreg = 0;
...
/**
  ...
  * @retval None
  */
void RCC_I2S3CLKConfig(
    uint32_t RCC_I2S3CLKSource
)
{
    /* Check the parameters */
