...
void FLASH_HalfCycleAccessCmd(
    uint32_t FLASH_HalfCycleAccess
)
{
    /* Check the parameters */
...
/**
  ...
  *   FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status FLASH_EraseAllBank1Pages(
    void
)
{
    FLASH_Status status = FLASH_COMPLETE;
...
/**
  ...
  *   FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status FLASH_EraseAllBank2Pages(
    void
)
{
    FLASH_Status status = FLASH_COMPLETE;
...
)
{
    ...
    if (status == FLASH_COMPLETE)
    {
        ...
        OB->USER =
            OB_IWDG | (uint16_t) (OB_STOP | (uint16_t) (OB_STDBY | ((uint16_t)
                                  0xF8)));
...
/**
  ...
  *   and RST_STDBY(Bit2).
  */
uint32_t FLASH_GetUserOptionByte(
    void
)
{
...
/**
  ...
  */
uint32_t FLASH_GetWriteProtectionOptionByte(
    void
)
{
...
/**
  ...
  */
FlagStatus FLASH_GetPrefetchBufferStatus(
    void
)
{
...
/**
  ...
  *   FLASH_ERROR_WRP or FLASH_COMPLETE
  */
FLASH_Status FLASH_GetBank2Status(
    void
)
{
    FLASH_Status flashstatus = FLASH_COMPLETE;
...
/**
  ...
  *   FLASH_ERROR_WRP, FLASH_COMPLETE or FLASH_TIMEOUT.
  */
FLASH_Status FLASH_WaitForLastBank1Operation(
    uint32_t Timeout
)
{
    FLASH_Status status = FLASH_COMPLETE;
