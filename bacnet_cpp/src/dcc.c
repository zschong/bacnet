...
BACNET_COMMUNICATION_ENABLE_DISABLE dcc_enable_status(void *thisp)
{
    return DCC_Enable_Disable;
}

bool dcc_communication_enabled(void *thisp)
{
...
bool dcc_communication_disabled(void *thisp)
{
...
)
{
    ...
    BACNET_COMMUNICATION_ENABLE_DISABLE test_enable_disable	= 0;
